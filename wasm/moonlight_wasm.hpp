...
class MoonlightInstance {
  ...
  void OpenUrl(int callbackId, std::string url, std::string ppk, bool binaryResponse, int timeoutMs);
  ...
  void OpenUrl_private(int callbackId, std::string url, std::string ppk, bool binaryResponse, int timeoutMs);
