...
void LiUpdateEstimatedNetworkLoss(uint32_t intervalFecTotalPackets, uint32_t intervalFecReceivedPackets, uint32_t intervalSeenFrameCount, uint32_t intervalGoodFrameCount);
